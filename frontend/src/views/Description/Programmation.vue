   ...
   <div class="container">
       <div class="row">
           <div class="col-xl-12">
               ...
               <p class="p-heading">Apprenez les bases de la programmation et développez des compétences en codage à travers des projets passionnants.</p>
           </div> 
       </div>   
       <div class="row">
           <div class="col-xl-5">
                   ...
                   <div class="accordion-item">
                       ...
                       <div class="accordion-header" id="headingThree">
                        <h5><button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            Familiariser les enfants avec les bases de la programmation, y compris les structures de contrôle, les fonctions et les variables.
                           </button></h5>
                       </div>
                   ...
                   <div class="accordion-item">
                       ...
                       <div class="accordion-header" id="headingFour">
                        <h5><button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                            Encourager les enfants à développer des compétences pratiques en codage à travers la création de projets informatiques.
                           </button></h5>
                       </div>
