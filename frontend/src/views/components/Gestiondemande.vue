        ...
        <tbody>
          <tr v-for="(demande, index) in demandes" :key="index" class="p-4 mb-2 bg-gray-100 border-radius-lg">
            ...
            <td class="text-center">
              <span class="text-s">{{demande.parent_id }}</span>
            </td>
            <td class="text-center">
              <span class="text-s">{{ demande.datedemande }}</span>
            </td>
            <td class="text-center">
            ...
            <td class="align-middle">
              <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="javascript:;">
                <argon-button>                  
                <router-link :to="`/dashboard-admin/Demandes/${demandeId}/paye`"><i class="fas fa-user-check text-dark me-2" aria-hidden="true">payé</i
                  ></router-link>
            </argon-button>
          </a>
          </td>
